...
class SahaLocalizations {
  ...
  static const _localizedStrings = <String, Map<String, String>>{
    'ar': {
      ...
      'invalid_name': 'يرجى إدخال اسم صالح من حرفين على الأقل',
      'name': 'الاسم',
      'sign_up': 'تسجيل حساب',
      'or': 'أو',
      'book_now': 'احجز الآن',
      ...
      'split_payment': 'دفع مشترك',
      'qr_checkin': 'تسجيل الدخول بالرمز',
      'qr_checkin_hint': 'اعرض هذا الرمز عند الوصول لإتمام تسجيل الدخول التجريبي.',
      'zoom': 'تكبير',
    ...
    'en': {
      ...
      'invalid_name': 'Please enter a valid name (min 2 characters).',
      'name': 'Name',
      'sign_up': 'Sign Up',
      'or': 'or',
      'book_now': 'Book Now',
      ...
      'qr_checkin_hint': 'Show this QR on arrival to complete the mock check-in.',
      'zoom': 'Zoom',
